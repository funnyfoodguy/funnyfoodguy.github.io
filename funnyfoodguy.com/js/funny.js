...
;
/*
 * Dedicated to the only person I care more about than myself.
*/
...
jQuery.extend( jQuery.easing,
{
  easeInOutMaterial: function (x, t, b, c, d) {
	...
	Shout-outs to Joey Coco Diaz and The Church of What's Happening Now
*/
...
/*
 * What I would give to have one more day...
 */
(function(window) {
  var lastTime = 0,
    vendors = ['webkit', 'moz'],
...
/*
	Tetrahydrocannabinol is not a drug, momo. Just because a certain species of plant reacts with specific brain receptors, doesn't mean shit. 
	It means that humans happened to develop a receptor that interacts with compounds in cannabis. Nothing more.
 */
...
/*
	If cannabis actually impaired any sort of normal functions, perhaps it could be considered a drug. But it hinders absolutely nothing and is less harmful than literally any actual drug.
 */
      ...
      <div class="row">
        <div class="col s12 m4">
          <div class="icon-block">
            <h2 class="center">Fire Starter</h2>
            <h5 class="center">Only Constraint is Time</h5>
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            <h2 class="center">Blizzy Proponent</h2>
            <h5 class="center">Roll Up or Die</h5>

            <p class="light">Always get your daily serving of green vegetables. To get just the right consistency, one must grind the herbs and spices by hand. To be blunt, there are only two things you need: nuggets and a wrap. When making arts and crafts, don't tuck too tight. However, too loose can be even worse. The only people who don't make arts and crafts are the ones who don't know how to. If you aren't hitting the Backwoods every night, you're doing something wrong. It's not easy being a quadrilateral to cylinder enthusiast.</p>
          </div>
        </div>

        <div class="col s12 m4">
          <div class="icon-block">
            <h2 class="center">Good Kid</h2>
            <h5 class="center">Cold World</h5>

            <p class="light">Throughout my time in school, I attended most of the honors and advanced placement courses offered. During all four years of high school, I never missed a day of class. In fact, I was never even late for a day of high school once. Although I did very well all throughout my time in school, I never could find any real interest in any of the subjects offered. College to me was no different. After a number of disheartening events, the only reasonable option for me was to drop out of college. Now I'm able to spend my time creating what I've always wanted to.</p>
          </div>
        </div>
      </div>
 */
...
;/*
	I'm not a programmer. I'm just a fairly intelligent blunt roller.
 */
...
;/*
	Someone told me that your dad left because your mother fucks dolphins.
 */
